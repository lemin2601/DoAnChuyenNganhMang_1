...
public class ServerGUI extends javax.swing.JFrame {
    ...
    private void btnConnectDatabaseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConnectDatabaseActionPerformed
        // TODO add your handling code here:
        if (this.isConnected) {
            System.out.println("stoppppppppppppppppp");
            if (stopConnectToDatabase()) {
                btnConnectDatabase.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Start-icon.png"))); // NOI18N
            }
            this.isConnected = false;
            viewClearAll();
            this.txtIpDatabase.setEnabled(true);
            this.txtIpServer.setEnabled(true);
            this.btnAutoDetectIp.setEnabled(true);
            btnConnectDatabase.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Start-icon.png"))); // NOI18N
            ...
            if (connectToDataBase()) {
                ...
                this.txtIpDatabase.setEnabled(false);
                this.txtIpServer.setEnabled(false);
                this.btnAutoDetectIp.setEnabled(false);
            } else {
                JOptionPane.showMessageDialog(this, "Can't connect, try again");
            }
        }
